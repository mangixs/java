...
public class SignUtil {
     ...
     * @return
     */
    public static String getSign(WintiRequestMsg requestMsg, String token) {
     ...
     * @return
     */
    public static String getSign(WintiRequestMsg requestMsg, String token, String jsonStr) {
     ...
     * @return
     */
    private static String buildJsonStr(WintiRequestMsg requestMsg, String token) {
